      ...
      <div className="relative bg-background rounded-xl shadow-2xl w-full max-w-md m-4 animate-in zoom-in-95 duration-200 border overflow-hidden">
        ...
        <div className="p-6 space-y-4">
          ...
          <p className="text-xs text-muted-foreground bg-muted/50 rounded-lg p-3">
            {isEn
              ? 'When minimized to tray, the app will continue running in the background. You can reopen the window by clicking the tray icon.'
          ...
          <div className="space-y-2">
            ...
            >
              ...
              <div className="text-left">
                ...
                <div className="text-xs text-muted-foreground">
                  {isEn ? 'Continue running in background' : '在后台继续运行'}
                </div>
              </div>
            </Button>
            ...
            >
              ...
              <div className="text-left">
                ...
                <div className="text-xs text-muted-foreground">
                  {isEn ? 'Close the app completely' : '完全关闭应用'}
                </div>
              </div>
            </Button>
          </div>
          ...
          {/* 取消按钮 */}
          <Button variant="ghost" className="w-full" onClick={() => handleAction('cancel')}>
            {isEn ? 'Cancel' : '取消'}
          </Button>
        </div>
      </div>
